...
<nav class="space-y-2 mt-6 text-xs">
  <div class="flex items-center gap-3">
    <span class="bg-gray-200 text-gray-700 rounded-full w-5 h-5 flex items-center justify-center font-bold text-xs">1</span>
    <span>Аналитический расчет</span>
  </div>
  <div class="flex items-center gap-3">
    <span class="bg-gray-200 text-gray-700 rounded-full w-5 h-5 flex items-center justify-center font-bold text-xs">2</span>
    <span>Выбор оптимальных параметров</span>
  </div>
  <div class="flex items-center gap-3">
    <span class="bg-gray-200 text-gray-700 rounded-full w-5 h-5 flex items-center justify-center font-bold text-xs">3</span>
    <span>Прямое отображение ДПФ</span>
  </div>
  <div class="flex items-center gap-3">
    <span class="bg-gray-200 text-gray-700 rounded-full w-5 h-5 flex items-center justify-center font-bold text-xs">4</span>
    <span>Обратное отображение ДПФ</span>
  </div>
  <div class="flex items-center gap-3">
    <span class="bg-gray-200 text-gray-700 rounded-full w-5 h-5 flex items-center justify-center font-bold text-xs">5</span>
...
<a href="/analytical_calculation.html" target="_blank" 
...
## V. Анализ эталонной реализации из пакета `numpy.fft`
...
<a href="/reference_implementation.html" target="_blank" 
     class="flex items-center gap-5 p-5 border border-white/10 bg-white/5 hover:bg-white/10 hover:border-blue-500/50 rounded-xl transition-all duration-200 group no-underline text-current w-full block">
    <div class="w-12 h-12 rounded-xl bg-blue-500/10 flex items-center justify-center text-xl text-blue-400 group-hover:scale-105 transition-transform shrink-0">
      📊
    </div>

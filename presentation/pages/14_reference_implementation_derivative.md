...
## X. Анализ эталонной реализации из пакета `numpy.fft`

Воспользуемся реализацией прямого и обратного отображения ДПФ из пакета `numpy.fft` и качественно оценим, насколько 
точно они воспроизводят спектр производной сигнала и его восстановление на примере производной исходного бигармонического сигнала.

<a href="/reference_implementation_derivative.html" target="_blank" 
...
<div class="mt-4 p-2 bg-green-950/40 border border-green-800/60 rounded text-center text-green-300 text-xs">
  ...
  воспроизводит спектр производной сигнала и восстанавливает его по спектру. 
</div>
